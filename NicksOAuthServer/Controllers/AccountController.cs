...
using NicksOAuthServer.Results;
...
namespace NicksOAuthServer.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("Revoke")]
        public async Task<IHttpActionResult> PostRevoke(OAuthTokenRevocationBindingModel model)
        {
            ...
            if (string.Compare(auth.Scheme, "Basic", StringComparison.OrdinalIgnoreCase) == 0)
            {
                ...
                if (separatorIndex >= 0)
                {
                    string clientId = credentials.Substring(0, separatorIndex);
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = NicksApplicationOAuthProvider.CreateProperties(user.UserName);
